...
class Conway extends React.Component {
    ...
    state = {
        ...
        //add intervals and running state
...
//this.newGrid is where the next frame to be shown is being actively constructed
        ...
        this.setState({ iternum: this.state.iternum + 1 });   //increase iteration count

        for (let y = 0; y < this.rows; y++) {
            for (let x = 0; x < this.cols; x++) {
                let neighbors = this.calcAdjacent(this.grid, x, y);
                if (this.grid[y][x]) {
     ...
     // Calculate the number of neighbors at given coordinate
        ...
        return (
            <div>
                <div className="userInterface">
                    ...
                    <button className="animated-button1" onClick={this.handleSample1}><span></span><span></span><span></span><span></span>Sample 1</button>
                    <button className="animated-button1" onClick={this.handleSample2}><span></span><span></span><span></span><span></span>Sample 2</button>
                    <button className="animated-button1" onClick={this.handleSample3}><span></span><span></span><span></span><span></span>Sample 3</button>
